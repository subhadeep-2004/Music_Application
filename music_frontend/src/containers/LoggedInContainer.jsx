...
function  LoggedInContainer({children,currActiveScreen,songData}){
    ...
    return (
            ...
            <div className="side-bar h-full w-1/5 bg-black flex flex-col justify-between ">
                ...
                <div className=" w-full  ">
                    ...
                    <div className='icon border border-emerald-500 rounded-full flex justify-center m-4 p-4' >
                        ...
                        <h1 className='login-text ml-2 font-bold  text-2xl text-white '>Musicify</h1>  
                    </div>
                </div>
                ...
                <IconText name="gala:add"
                        ...
                        onClick={()=>{setCreatePlayListModalOccur(true)}} //first time hitting the create-playlist button
