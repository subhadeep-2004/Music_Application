...
function  UploadSong(){
  ...
  const cld = new Cloudinary({
    ...
    return (<LoggedInContainer songData={songData} currActiveScreen="uploadSong" >
        ...
        <input id="name" type="text" placeholder="Enter the name" className="p-2 border text-sm border-gray-400 rounded-full my-3" 
        value={name}
        onFocus={()=>{
        ...
        <input id="Thumbnail" type="text" placeholder="Enter the Thumbnail" className="p-2 border text-sm border-gray-400  my-3 rounded-full" 
        value={thumbnail}
